    ...
    <aside className="sidebar">
      <nav className="menu">
        ...
        <div className="menu__item">
          <a href="#" className="menu__link">
            <img className="menu__icon" src="assets/icons/house.svg" alt="Domů" />
            <span className="menu__text">Domů</span>
          </a>
        </div>
        <div className="menu__item">
          <a href="#" className="menu__link">
            <img className="menu__icon" src="assets/icons/bookmark.svg" alt="Záložky" />
            <span className="menu__text">Záložky</span>
          </a>
        </div>
        <div className="menu__item">
          <a href="#" className="menu__link">
            <img className="menu__icon" src="assets/icons/heart.svg" alt="Lajky" />
